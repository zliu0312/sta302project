...
hist(df$log_total_revenue, breaks=20, main = "Histogram of the distribution of Log Total Revenue", xlab = "Log Total Revenue") # Looks more normally distributed, more fit for linear regression, thus we investigate log total revenue
```
...
pairs(~ log_total_revenue + age_of_exp + price + review_scores_value + accommodates + host_response_rate, data = df, 
      main = "Scatterplot Matrix of AirBnB Variables agains Log Total Revenue", cex = 0.01)
...
Q-Q Plot: Check if data is on 45 degree line.
...
interpretability of our model by adding complexity to our transformed predictor.

## Final Data Cleaning (Removing all unused columns in analysis)
