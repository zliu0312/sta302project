...
hist(df$total_revenue_clean/1000, breaks=20,
     main="Histogram of the Distribution of Total Revenue",
     xlab="Total Revenue ($1000)",)
hist(df$log_total_revenue, breaks=20, 
     main="Histogram of the Distribution of Log Total Revenue", 
     xlab="Log of Total Revenue")
boxplot(df$log_total_revenue, 
        main="Boxplot of the Distribution of Log Total Revenue", 
        ylab="Log of Total Revenue", 
        cex=0.7)
```
...
pairs(~ log_total_revenue + age_of_exp + price + review_scores_value + accommodates + host_response_rate, data = df, 
      main = "Scatterplot Matrix of Log Total Revenue and AirBnB Variables", cex = 0.01)
```

```{r log revenue plot numeric 2}
pairs(~ log_total_revenue + log_age_of_exp + log_price + review_scores_value + sqrt_accommodates + host_response_rate, data = df, 
      main = "Scatterplot Matrix of Transformed AirBnB Variables", cex = 0.01)
```
